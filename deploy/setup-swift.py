...
def get_source_code(server):
    ...
    server.local("rm -rf /home/Jarrett/project/SWE/Swift/.git")
    server.local("rm -rf /home/Jarrett/projects/SWE/Swift/__pycache__")
    server.local("pushd /home/Jarrett/projects/SWE/Swift; tar cvf /home/Jarrett/swift.tar . ; popd", hide=False)
...
if __name__ == "__main__":
    server = Server( host = "3.23.101.233", user="ubuntu", key_filename="/home/Jarrett/.ssh/Lightsail-Ohio.pem")
